#!/usr/bin/env python3
"""
Charlie_Recon - Automated Reconnaissance & Vulnerability Scanner
Author: ImrulMir
Version: 1.0.0

Main CLI entry point. Run: python charlie_recon.py -t <target>
"""
...
def parse_args():
    ...
    parser = argparse.ArgumentParser(
        ...
        epilog="""
Examples:
  python charlie_recon.py -t example.com
  python charlie_recon.py -t https://example.com -o results --threads 20
  python charlie_recon.py -t 192.168.1.1 --nikto --nuclei
  python charlie_recon.py -t example.com --stealth --depth 5
  python charlie_recon.py -t example.com --skip-vuln
        """
    )
    ...
    parser.add_argument(
        "-o", "--output",
        default=None,
        help="Output directory (default: charlie_recon_output)"
    )
...
def main():
    """Main entry point for Charlie_Recon."""
    try:
        args = parse_args()
