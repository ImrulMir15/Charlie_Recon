"""
Charlie_Recon - Custom Logger Module
Author: ImrulMir
...
class Logger:
    """Custom logger providing styled console output for Charlie_Recon."""

    BANNER = r"""
[bold green]
   _____ _                 _ _        _____
  / ____| |               | (_)      |  __ \
 | |    | |__   __ _ _ __| |_  ___  | |__) |___  ___ ___  _ __
 | |    | '_ \ / _` | '__| | |/ _ \ |  _  // _ \/ __/ _ \| '_ \
 | |____| | | | (_| | |  | | |  __/ | | \ \  __/ (_| (_) | | | |
  \_____|_| |_|\__,_|_|  |_|_|\___| |_|  \_\___|\___\___/|_| |_|
[/bold green]
[bold cyan]  ══════════════════════════════════════════════════════[/bold cyan]
[bold white]  ⚡ Automated Reconnaissance & Vulnerability Scanner[/bold white]
[bold dim]  Version 1.0.0  |  Author: ImrulMir[/bold dim]
[bold cyan]  ══════════════════════════════════════════════════════[/bold cyan]
"""

    @staticmethod
    def banner():
        """Display the Charlie_Recon ASCII banner."""
    ...
    def scan_complete(duration, output_path):
        ...
        console.print(Panel(
            ...
            title="[bold green]⚡ CHARLIE_RECON COMPLETE[/bold green]",
            border_style="green",
            box=box.DOUBLE_EDGE,
            padding=(1, 2)
        ))
